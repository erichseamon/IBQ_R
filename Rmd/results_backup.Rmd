...
Explanation of modeling development and outputs.
...
fit_rf_gender <- caret::train(fmla, data=training, method="rf", trControl = train_control)
...
legend(.01,.99, txt, lty = 1, col = c(1:11), cex = .5)
...
# 
# 
# testing$pred_svm<-predict(object = fit_svm_gender,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_svm)
# 
# testing$pred_rf<-predict(object = fit_rf_gender,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_rf)
# 
# 
# testing$pred_lda<-predict(object = fit_lda_gender,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_lda)
# 
# 
# testing$pred_gbm<-predict(object = fit_gbm_gender,testing[,predictors])
...
fit_rf_agegrp <- caret::train(fmla, data=training, method="rf", trControl = train_control)
fit_lda_agegrp <- caret::train(fmla, data=training, method="lda", trControl = train_control)
fit_glm_agegrp <- caret::train(fmla, data=training, trControl = train_control, method="multinom")  #altered to multinom given multiple classes
fit_knn_agegrp <- caret::train(fmla, data=training, method="knn",trControl = train_control)
fit_nb_agegrp <- caret::train(fmla, data=training, method="nb", trControl = train_control)
fit_svm_agegrp <- caret::train(fmla, data=training, method="svmRadial", trControl = train_control)
fit_cart_agegrp <- caret::train(fmla, data=training, method="rpart", trControl = train_control)
fit_c50_agegrp <- caret::train(fmla, data=training, method="C5.0", trControl = train_control)
fit_treebag_agegrp <- caret::train(fmla, data=training, method="treebag", trControl = train_control)
fit_gbm_agegrp <- caret::train(fmla, data=training, method="gbm", trControl = train_control, verbose = FALSE)
fit_adabag_agegrp <- caret::train(fmla, data=training, method="AdaBag", trControl = train_control)
...
# 
# #multiclass testing
# roc.multi <- multiclass.roc(testing$AgeGrp, predictions)
# auc(roc.multi)
# 
# rs <- roc.multi[['rocs']]
# plot.roc(rs[[1]])
...
# 
# 
# testing$pred_svm<-predict(object = fit_svm_agegrp,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_svm)
# 
# testing$pred_rf<-predict(object = fit_rf_agegrp,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_rf)
# 
# 
# testing$pred_lda<-predict(object = fit_lda_agegrp,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_lda)
# 
# 
# testing$pred_glm<-predict(object = fit_glm_agegrp,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_glm)
# 
# 
# testing$pred_gbm<-predict(object = fit_gbm_agegrp,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_gbm)
...
fit_rf_gender_age_one <- caret::train(fmla, data=training, method="rf", trControl = train_control)
...
# 
# 
# testing$pred_svm<-predict(object = fit_svm_gender_age_one,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_svm)
# 
# testing$pred_rf<-predict(object = fit_rf_gender_age_one,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_rf)
# 
# 
# testing$pred_lda<-predict(object = fit_lda_gender_age_one,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_lda)
# 
# 
# testing$pred_glm<-predict(object = fit_glm_gender_age_one,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_glm)
# 
# 
# testing$pred_gbm<-predict(object = fit_gbm_gender_age_one,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_gbm)
...
fit_rf_gender_age_two <- caret::train(fmla, data=training, method="rf", trControl = train_control)
...
# 
# 
# testing$pred_svm<-predict(object = fit_svm_gender_age_two,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_svm)
# 
# testing$pred_rf<-predict(object = fit_rf_gender_age_two,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_rf)
# 
# 
# testing$pred_lda<-predict(object = fit_lda_gender_age_two,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_lda)
# 
# 
# testing$pred_glm<-predict(object = fit_glm_gender_age_two,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_glm)
# 
# 
# testing$pred_gbm<-predict(object = fit_gbm_gender_age_two,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_gbm)
# 
# 
...
fit_rf_gender_age_three <- caret::train(fmla, data=training, method="rf", trControl = train_control)
...
legend(.003,.995, txt, lty = 1, col = c(1:11), cex = .5)


#confusion matrix results
# 
# 
# testing$pred_svm<-predict(object = fit_svm_gender_age_three,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_svm)
# 
# testing$pred_rf<-predict(object = fit_rf_gender_age_three,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_rf)
# 
# 
# testing$pred_lda<-predict(object = fit_lda_gender_age_three,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_lda)
# 
# 
# testing$pred_glm<-predict(object = fit_glm_gender_age_three,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_glm)
# 
# 
# testing$pred_gbm<-predict(object = fit_gbm_gender_age_three,testing[,predictors])
# confusionMatrix(testing$infantgender,testing$pred_gbm)
...
## Model Development and Output: Kmeans clustering
...
colnames(agegroups) <- c("age1 accuracy", "age1 kappa", "age1 AUC", "age2 accuracy", "age2 kappa", "age2 AUC", "age3 accuracy", "age3 kappa", "age3 AUC")
